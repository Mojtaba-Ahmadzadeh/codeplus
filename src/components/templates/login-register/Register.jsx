            ...
            <div className="max-w-[330px] w-full pt-5 pb-6 px-6 text-center bg-white dark:bg-gray-800 rounded-xl shadow-lg">
                ...
                <div className="user-data">
                    ...
                    <p className="mb-5 text-gray-600 dark:text-gray-300">
                        قبلا ثبت نام کردید؟
                        <button onClick={showLoginForm} className="font-semibold text-green-500 hover:underline">وارد شوید</button>
                    </p>

                    <form className="space-y-5">
                        {/* <!-- Phone Input --> */}
                        <div className="relative mb-4">
                            <input type="text" placeholder="نام کاربری" className="w-full border border-gray-300 bg-gray-100 rounded-lg px-10 py-2 text-right
                focus:outline-none
                dark:bg-gray-700 dark:border-gray-600 dark:text-white
                transition-colors duration-300 ease-in-out
                focus:border-green-500
                focus:shadow-sm focus:shadow-green-500/30" />
                            <i className="absolute left-3 top-1/2 -translate-y-1/2 w-3 h-3 text-gray-400 fas fa-user"></i>
                        </div>
                ...
                focus:shadow-sm focus:shadow-green-500/30" />
                        ...
                        <div className="relative mb-4">
                            <input type="email" placeholder="ایمیل" className="w-full border border-gray-300 bg-gray-100 rounded-lg px-10 py-2 text-right
                focus:outline-none
                dark:bg-gray-700 dark:border-gray-600 dark:text-white
                transition-colors duration-300 ease-in-out
                focus:border-green-500
                focus:shadow-sm focus:shadow-green-500/30" />
                            <i className="absolute left-3 top-1/2 -translate-y-1/2 w-3 h-3 text-gray-400 fas fa-envelope"></i>
                        </div>

                        <div className="relative mb-4">
                            <input type="password" placeholder="رمز عبور" className="w-full border border-gray-300 bg-gray-100 rounded-lg px-10 py-2 text-right
                focus:outline-none
                dark:bg-gray-700 dark:border-gray-600 dark:text-white
                transition-colors duration-300 ease-in-out
                focus:border-green-500
                focus:shadow-sm focus:shadow-green-500/30" />
                            <i className="absolute left-3 top-1/2 -translate-y-1/2 w-3 h-3 text-gray-400 fas fa-lock"></i>
                        </div>
