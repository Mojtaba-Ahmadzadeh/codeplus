export default function Topbar() {
    return (
        <header className="flex items-center justify-between shrink-0 w-full h-22 px-5 py-4 sm:px-7 bg-white dark:bg-gray-800 lg:rounded-lg">
            ...
            {/* <!-- جستجو (نمایش فقط روی md به بالا) --> */}
            ...
            <div className="flex items-center gap-x-5">
                ...
                <div className="flex items-center gap-x-2">
                    <button id="toggleThemeBtn" className="btn-icon-area text-primary dark:text-indigo-400 flex items-center justify-center p-2 rounded hover:bg-gray-200 dark:hover:bg-gray-700 transition" aria-label="تغییر تم">
                        <i className="fa-solid fa-moon" id="moonIcon" style={{ fontSize: '1.2rem' }}></i>
                        <i className="fa-solid fa-sun hidden" id="sunIcon" style={{ fontSize: '1.2rem' }}></i>
                    </button>
                ...
                <div className="max-lg:hidden flex items-center gap-x-4 text-label text-secondary dark:text-gray-400 select-none">
                    <time dateTime="2025-08-06T07:25:53.344Z" className="text-gray-700 dark:text-gray-400">چهارشنبه
                        ۱۵ مرداد</time>
